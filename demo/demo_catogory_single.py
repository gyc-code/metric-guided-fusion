...
def get_parser():
    ...
    parser.add_argument(
        "--output",
        default='visual_instance/cityscapes_upperbound',
    ...
    parser.add_argument(
        ...
        default=['MODEL.WEIGHTS','./pretrain/cityscapes-mask2former-200queries-swinL-90k-model_final_dfa862.pkl'],
...
def process_one(path, demo_human_cycle, _metadata, result_save_folder, visul_save_folder, error_map_save_folder):
...
if __name__ == "__main__":
    ...
    error_map_save_folder = folder + cfg['MODEL']['WEIGHTS'].split('/')[-2] + '_error_map'
