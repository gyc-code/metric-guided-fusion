...
class TaskScaledNorm(nn.Module):
    r"""Applies Task Scaled Normalization over a mini-batch of inputs.
    ...
    evaluation modes. The affine transformation is modulated by a task scaled tensor.
    In our case, we use task embeddings.
    ...
    def __init__(self, normalized_shape, condition_size, eps=1e-5):
        super(TaskScaledNorm, self).__init__()
