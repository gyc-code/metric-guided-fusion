...
class CityscapesCustomEvaluator(DatasetEvaluator):
    """
...
class CityscapesCustomInstanceEvaluator(CityscapesCustomEvaluator):
    """
    ...
    def evaluate(self):
        ...
        cityscapes_eval.args.gtInstancesFile = os.path.join(self._working_dir, "gtInstances.json")
...
class CityscapesCustomInstance2SemSegEvaluator(CityscapesCustomEvaluator):
    """
    Evaluate semantic segmentation results on cityscapes dataset using cityscapes API.
    ...
    def process_instance2semantic(self, inputs, outputs, name2label):
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                visual_pred_filename = os.path.join(self._working_dir, basename + "_visual_pred.png")
    ...
    def evaluate(self):
        ...
        # self._working_dir.cleanup()
        self._logger.info(ret_instance2semaic)
